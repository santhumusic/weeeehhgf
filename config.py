...
ABUSE_SPAM = [
    ...
    "Mg ra suliga", 
    "Ammayai puku naku koja nakodKa", 
    "Arya pedha koja gadu", 
    "Arya pedha pulihora lanajakoduku", 
    "Arya gudhalo karam petali😀", 
    "Arya gadini entha mandhi dengitharu🙂", 
    "Rey Arya mg ra😅", 
    "Rey Arya chaka ga😑", 
    "Arya gani gudhalo bomb pedutha🍀", 
    "Arya pedha ja nakoduku", 
    "Rey Arya rasika raja nj grp loki amayalu vasthe valani bathakinava andhiritho bava ani pichukutav😑 siggu undali aleredy neku gf undhi gara koja", 
]
